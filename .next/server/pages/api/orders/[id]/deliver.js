...
/* harmony import */ var _utils_error__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6423);
...
router.use(_utils_auth__WEBPACK_IMPORTED_MODULE_4__/* .isAuth */ .$D).put(async (req, res)=>{
    await _utils_db__WEBPACK_IMPORTED_MODULE_2__/* ["default"].connect */ .Z.connect();
    const order = await _models_Order__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findById */ .Z.findById({
        _id: req.query.id
    });
    if (order) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router.handler({
    onError: _utils_error__WEBPACK_IMPORTED_MODULE_3__/* .onError */ .q
}));
...
var __webpack_exports__ = __webpack_require__.X(0, [4323,9407,6125], () => (__webpack_exec__(7599)));
