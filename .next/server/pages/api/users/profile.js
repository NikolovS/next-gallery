...
router.use(_utils_auth__WEBPACK_IMPORTED_MODULE_4__/* .isAuth */ .$D).put(async (req, res)=>{
    ...
    user.password = req.body.password ? bcryptjs__WEBPACK_IMPORTED_MODULE_3___default().hashSync(req.body.password) : user.password;
    await user.save();
...
var __webpack_exports__ = __webpack_require__.X(0, [4323,9407], () => (__webpack_exec__(7861)));
