...
router.post(async (req, res)=>{
    ...
    const newUser = new _models_User__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z({
        ...
        password: bcryptjs__WEBPACK_IMPORTED_MODULE_3___default().hashSync(req.body.password),
        isAdmin: false
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [4323,9407], () => (__webpack_exec__(7767)));
